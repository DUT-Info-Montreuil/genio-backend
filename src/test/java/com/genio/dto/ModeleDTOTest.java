...
class ModeleDTOTest {
    ...
    void testConstructorAndGetters() {
        ModeleDTO dto = new ModeleDTO(1L, "modele2025.docx", "2025", "docx", "2024-01-01");
    ...
    @Test
    void testSetters() {
        ModeleDTO dto = new ModeleDTO(null, null, null, null, null);
    ...
    @Test
    void testToString() {
        ModeleDTO dto = new ModeleDTO(3L, "model.docx", "2023", "docx", "2023-05-10");
