...
public class ErrorMessages {
    ...
    public static final String INVALID_STUDENT_FIRST_NAME = "Le prénom de l'étudiant doit être une chaîne alphabétique.";
    public static final String MISSING_STUDENT_EMAIL = "L'email de l'étudiant est manquant.";
    public static final String INVALID_STUDENT_EMAIL = "L'email de l'étudiant est invalide.";
    public static final String MISSING_STUDENT_ADDRESS = "L'adresse de l'étudiant est manquante.";
    public static final String MISSING_STUDENT_PHONE = "Le téléphone de l'étudiant est manquant.";
    public static final String INVALID_STUDENT_PHONE = "Le téléphone de l'étudiant doit être au format XX.XX.XX.XX.XX.";
    public static final String MISSING_STUDENT_SEX = "Le sexe de l'étudiant est manquant.";
    public static final String INVALID_STUDENT_SEX = "Le sexe de l'étudiant doit être 'H' ou 'F'.";
    ...
    public static final String INVALID_TUTOR_FIRST_NAME = "Le prénom du tuteur doit être une chaîne alphabétique.";
    public static final String MISSING_TUTOR_EMAIL = "L'email du tuteur est manquant.";
    public static final String INVALID_TUTOR_EMAIL = "L'email du tuteur est invalide.";
    public static final String MISSING_TUTOR_PHONE = "Le téléphone du tuteur est manquant.";
    ...
    public static final String INVALID_TEACHER_FIRST_NAME = "Le prénom de l'enseignant doit être une chaîne alphabétique.";
    ...
    public static final String MISSING_ORGANIZATION_REPRESENTATIVE_NAME = "Le nom du représentant de l'organisme est manquant.";
    public static final String MISSING_ORGANIZATION_REPRESENTATIVE_QUALITY = "La qualité du représentant de l'organisme est manquante.";
    public static final String MISSING_ORGANIZATION_SERVICE_NAME = "Le nom du service de l'organisme est manquant.";
    public static final String MISSING_ORGANIZATION_PHONE = "Le téléphone de l'organisme est manquant.";
    public static final String INVALID_ORGANIZATION_PHONE = "Le téléphone de l'organisme doit être au format XX.XX.XX.XX.XX.";
    public static final String MISSING_ORGANIZATION_EMAIL = "L'email de l'organisme est manquant.";
    ...
    public static final String MISSING_STAGE_END_DATE = "La date de fin du stage est manquante.";
    public static final String INVALID_STAGE_END_DATE = "La date de fin doit être au format YYYY-MM-DD.";
